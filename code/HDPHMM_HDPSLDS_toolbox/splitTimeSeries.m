...
function splitTimeSeries(timeSeriesName)
saveDir = "./";
trial_vec = [1,2,3];
...
settings.Niter = 100;  % Number of iterations of the Gibbs sampler
...
model.HMMmodel.params.a_gamma=3;  % global expected # of HMM states (affects \beta)
